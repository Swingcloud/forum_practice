...
ActiveRecord::Schema.define(version: 20160919062738) do
  ...
  create_table "post_groupships", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    t.integer  "post_id"
    t.integer  "group_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["group_id"], name: "index_post_groupships_on_group_id", using: :btree
    t.index ["post_id"], name: "index_post_groupships_on_post_id", using: :btree
  end

  create_table "post_likeships", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    t.integer  "user_id"
    t.integer  "post_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["post_id"], name: "index_post_likeships_on_post_id", using: :btree
    t.index ["user_id"], name: "index_post_likeships_on_user_id", using: :btree
  end
  ...
  create_table "user_postships", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    t.integer  "post_id"
    t.integer  "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["post_id"], name: "index_user_postships_on_post_id", using: :btree
    t.index ["user_id"], name: "index_user_postships_on_user_id", using: :btree
  end
